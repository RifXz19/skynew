...
`.trim()
  conn.send2ButtonDoc(m.chat, `*${htki} ɪɴᴠᴇɴᴛᴏʀʏ ${htka}*`, caption, `${user.health < 60 ? 'ʜᴇᴀʟ': 'ᴀᴅᴠᴇɴᴛᴜʀᴇ'}`,`${user.health < 60 ? '.heal': '.adventure'}`, 'ᴘʀᴏғɪʟᴇ','.pp', m, { quoted : fkontak }, { mentions: await conn.parseMention(caption) } )
}
